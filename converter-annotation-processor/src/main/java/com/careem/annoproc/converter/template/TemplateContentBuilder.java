package com.careem.annoproc.converter.template;
...
import static com.careem.annoproc.helper.generator.Constants.INDENT;
import static com.careem.annoproc.helper.generator.Constants.INDENTS_MAP;
import static com.careem.annoproc.helper.generator.Constants.LINE_SEPARATOR;
...
public class TemplateContentBuilder {
    ...
    public TemplateContentBuilder(@NonNull BuilderConverterClassState state) throws IOException {
        final InputStream stream = getClass().getResourceAsStream("/com/careem/annoproc/converter/template/builder.txt");
    ...
    public String build() {
        ...
        final String vars = state.getClassVars().stream()
            ...
            .reduce(new LinesReducer(INDENT)::reduce)
            .map(s -> s + "\n").orElse("");
        ...
        final String INDENTS_2 = INDENTS_MAP.get(2);
    ...
    private class LinesReducer {
        ...
        public String reduce(String p, String c) {
            return p + LINE_SEPARATOR + prefix + c;
        }
    }
}
